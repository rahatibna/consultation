...
$admin = 'SELECT email from login where id =0';
...
<body>
  ...
  <div class="container">
    ...
    <a href="admin.php" class="btn btn-primary"><b>Admin DashBoard</b></a>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          while ($result = mysqli_fetch_assoc($res)) {
            $nstart = date('h:i A', strtotime($result['stime']));
            $nend = date('h:i A', strtotime($result['etime']));
          ?>
            <tr>
