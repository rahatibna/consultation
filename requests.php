...
<body>
  ...
  <div class="container">
    ...
    <a href="requests.php" class="btn btn-primary"><b>Appointment Requests</b></a>
  </div>
  <br><br>
    ...
    ?>
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          ?>
            <tr>
              <th scope="row"><?php echo $result11['id'] ?></th>
              ...
              <td>
                <a href="acceptApointment.php?id=<?php echo $result11['id'] ?>" class="btn btn-info">Accept</a>

                <a href="reject.php?id=<?php echo $result11['id'] ?>" class="btn btn-danger">Reject</a>
